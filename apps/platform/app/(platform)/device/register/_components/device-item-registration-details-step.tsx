...
interface DeviceItemRegistrationDetailsStepProps {
...
export function DeviceItemRegistrationDetailsStep({
  form,
}: DeviceItemRegistrationDetailsStepProps) {
  return (
